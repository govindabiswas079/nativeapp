...
const App = () => {
  ...
  BleManager.enableBluetooth()
    .then((response) => {
      // Success code
      console.log("The bluetooth is already enabled or the user confirm", response);
    })
    .catch((error) => {
      // Failure code
  ...
  console.log('deviceList', deviceList) // Name of peripheral device

  return (
    <View>
      <Button title='isStart' onPress={() => isStart()} />
      <Button title='isStop' onPress={() => isStop()} />
    </View>
  )
}
